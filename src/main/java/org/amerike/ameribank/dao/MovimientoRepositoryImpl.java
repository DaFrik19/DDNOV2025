...
public class MovimientoRepositoryImpl implements MovimientoRepository {
    ...
    public void registrarMovimiento(Movimiento movimiento) {
        String sql = "INSERT INTO movimientos (cuenta_id, tipo_movimiento, monto, descripcion, cuenta_remitente, cuenta_receptora, fecha_movimiento) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public List<Movimiento> obtenerMovimientosPorCliente(int clienteId) {
        String sql = "SELECT m.* FROM movimientos m JOIN cuentas c ON m.cuenta_id = c.id WHERE c.cliente_id = ? ORDER BY m.fecha_movimiento DESC";
        List<Movimiento> movimientos = new ArrayList<>();
    ...
    public List<Movimiento> obtenerMovimientosPorRangoFechas(int cuentaId, String fechaInicio, String fechaFin) {
        String sql = "SELECT * FROM movimientos WHERE cuenta_id = ? AND fecha_movimiento BETWEEN ? AND ? ORDER BY fecha_movimiento DESC";
        List<Movimiento> movimientos = new ArrayList<>();
